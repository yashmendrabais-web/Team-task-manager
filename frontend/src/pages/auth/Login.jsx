...
export const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-cyan-50 to-purple-50">
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-400 to-cyan-400 opacity-10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-br from-purple-400 to-pink-400 opacity-10 rounded-full blur-3xl"></div>
      <div className="relative w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl backdrop-blur-sm border border-white/20">
        ...
        <p className="text-center text-sm text-gray-600">
          ...
          <Link to="/register" className="font-semibold text-blue-600 hover:text-cyan-600 transition-colors">
            Sign up now
          </Link>
        </p>
      </div>
